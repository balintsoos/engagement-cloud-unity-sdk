...
internal class MacosLanguageTagValidator : LanguageTagValidatorApi {
    override suspend fun isValid(languageTag: String): Boolean {
        val locale = NSLocale(languageTag)
        return NSLocale.ISOLanguageCodes.contains(locale.languageCode) &&
                NSLocale.ISOCountryCodes().contains(locale.countryCode)
    }
}

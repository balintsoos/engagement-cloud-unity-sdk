...
internal class NWPathMonitorWrapper(
    ...
    init {
        val dispatchQueue: dispatch_queue_t = dispatch_queue_create("ems_queue_macos", null)
    ...
    override fun isConnected(): Boolean = isSatisfied
    override fun getNetworkConnection(): NetworkConnection = connectionStatus
